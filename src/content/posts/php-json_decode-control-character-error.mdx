...
pubDatetime: 2024-06-15T10:00:00+08:00
modDatetime: 2024-06-15T10:00:00+08:00
description: PHP 在进行 json 解析的时候会有很多报错，如果解析失败，可以使用jsonlasterrormsg方法，它会返回一个解析失败的原因。原因之一就有一个JSONERRORCTRLCHAR，表示Control character error, possibly incorrectly encoded，提示有可能 JSO...
draft: false
tags:
  - PHP
  - JSON
