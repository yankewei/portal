...
pubDatetime: 2026-05-18T10:00:00+08:00
modDatetime: 2026-05-18T10:00:00+08:00
description: 这段时间我在做一个很小的 coding agent 实验项目。它不是 Cursor，也不是 Codex，只是一个命令行里的 TypeScript 程序：用户输入一个任务，模型决定要不要读文件、搜索代码、修改文件、跑测试，然后一步步把事情做完。
draft: false
tags:
  - Agent
---
