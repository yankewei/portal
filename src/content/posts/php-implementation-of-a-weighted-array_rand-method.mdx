...
pubDatetime: 2025-05-15T10:00:00+08:00
modDatetime: 2025-05-15T10:00:00+08:00
description: PHP 字段的 arrayrand 方法是从 array 中随机挑选一个并返回元素的 key。但是有时候 array 中的元素是有权重的，权重越大概率被随机到的概率也就越大。像 Python 就提供了一个 random.choices 的方法。网上搜到一个带权重的随机数生成，正好可以使用 PHP 来实现带权重的 arr...
draft: false
tags:
  - PHP
---
